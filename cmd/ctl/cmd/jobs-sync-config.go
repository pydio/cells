...
var jobsSyncConfigCmd = &cobra.Command{
	Use:   "sync-config",
	Short: "Trigger a sync between Pydio 8",
	Long:  `Uses default configs for the moment`,
	Run:   newJobSyncConfig,
}

func newJobSyncConfig(cmd *cobra.Command, args []string) {
...
func init() {
	jobsCmd.AddCommand(jobsSyncConfigCmd)
}
