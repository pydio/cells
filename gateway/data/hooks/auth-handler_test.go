...
// Unlike the v5 tests, these suites do not cross-check with
// cmd.ExposedValidateRequestSignature: the v4 minio fork does not expose it.
// The assertions below still verify that the validators accept properly signed
// requests and reject uncovered ones.
