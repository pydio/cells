...
vi.mock('@mantine/dates', () => ({
    DateTimePicker: ({ value, onChange, leftSection, ...props }: any) => (
        <div data-testid="datetime-picker">
            <output data-testid="current-datetime">
            ...
            <button
                ...
                onClick={() =>
                    onChange(
                        value ? null : new Date('2024-02-10T14:30:00.000Z'),
                    )
                }
            >
                toggle
...
describe('DateTimeInputSearch', () => {
    ...
    describe('basic functionality', () => {
        it('should render with default props', () => {
            ...
            expect(screen.getByTestId('current-datetime')).toHaveTextContent(
                'null',
            );
        });
    ...
    describe('modifier integration', () => {
        it('should display modifier menu from SearchModifiers', () => {
            ...
            expect(
                screen.getByTestId('datetime-modifier-menu'),
            ).toBeInTheDocument();
        });
    ...
    describe('integration flow', () => {
        ...
        it('should preserve value through edit cycle with modifier', () => {
            ...
            expect(screen.getByTestId('current-datetime')).toContainHTML(
                '2024-02-10',
            );
