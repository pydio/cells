    ...
    render() {
        ...
        let stars = [-1, 0, 1, 2, 3, 4].map((v) => {
            ...
            return (
                <span
                    key={'star-' + v}
                    onClick={() => updateValue(v + 1, true)}
                    className={'mdi mdi-' + ic}
                    style={style}
                ></span>
            );
        });
        if (search) {
            return (
                <div
                    className="advanced-search-stars"
                    style={{
                        ...ModernStyles.div,
                        borderRadius:
                            ModernStyles.textFieldV1Search.inputStyle
                                .borderRadius,
                        ...starsStyle,
                        fontSize: 18,
                    }}
            ...
            return (
                <div
                    style={{
                        ...ModernStyles.textFieldV2.style,
                        borderBottom,
                        marginBottom: 6,
                        position: 'relative',
                    }}
