...
const { ModernTextField, ModernSelectField, ThemedModernStyles } =
...
class IntegerForm extends React.Component {
    ...
    render() {
                ...
                <div style={{ display: 'flex' }}>
                    <div style={{ width: 60, marginRight: 0 }}>
                        <ModernSelectField
                            ...
                            fullWidth={true}
                            value={searchComp}
                            onChange={(e, i, v) => updateValue(v + '' + value)}
                        >
        ...
        let textType = 'number',
            onChangeInt = (e, v) => updateValue(parseInt(v));
        switch (format) {
            case 'general':
