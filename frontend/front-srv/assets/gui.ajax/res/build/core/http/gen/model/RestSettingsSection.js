...
var _RestSettingsEntry = require('./RestSettingsEntry');
...
var RestSettingsSection = (function () {
    /**
    ...
    */
    ...
    RestSettingsSection.constructFromObject = function constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Children')) {
                obj['Children'] = _ApiClient2['default'].convertToType(data['Children'], [_RestSettingsEntry2['default']]);
            }
        }
        return obj;
    };
...
exports['default'] = RestSettingsSection;
