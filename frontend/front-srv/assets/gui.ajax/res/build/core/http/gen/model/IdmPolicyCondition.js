...
var IdmPolicyCondition = (function () {
    /**
    ...
    */
    ...
    IdmPolicyCondition.constructFromObject = function constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('jsonOptions')) {
                obj['jsonOptions'] = _ApiClient2['default'].convertToType(data['jsonOptions'], 'String');
            }
        }
        return obj;
    };
