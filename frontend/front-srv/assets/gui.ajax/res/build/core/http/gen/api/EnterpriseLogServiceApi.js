...
var EnterpriseLogServiceApi = (function () {
  ...
  */
  ...
  EnterpriseLogServiceApi.prototype.auditWithHttpInfo = function auditWithHttpInfo(body) {
    var postBody = body;
  ...
  EnterpriseLogServiceApi.prototype.audit = function audit(body) {
  ...
  EnterpriseLogServiceApi.prototype.auditChartDataWithHttpInfo = function auditChartDataWithHttpInfo(body) {
    var postBody = body;
  ...
  EnterpriseLogServiceApi.prototype.auditChartData = function auditChartData(body) {
  ...
  EnterpriseLogServiceApi.prototype.auditExportWithHttpInfo = function auditExportWithHttpInfo(body) {
    var postBody = body;
  ...
  EnterpriseLogServiceApi.prototype.auditExport = function auditExport(body) {
  ...
  EnterpriseLogServiceApi.prototype.syslogExportWithHttpInfo = function syslogExportWithHttpInfo(body) {
    var postBody = body;
  ...
  EnterpriseLogServiceApi.prototype.syslogExport = function syslogExport(body) {
