...
var LogTimeRangeRequest = (function () {
    /**
    ...
    */
    ...
    LogTimeRangeRequest.constructFromObject = function constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('TimeRangeType')) {
                obj['TimeRangeType'] = _ApiClient2['default'].convertToType(data['TimeRangeType'], 'String');
            }
