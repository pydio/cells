...
var HasherUtils = (function () {
    ...
    HasherUtils.utf8_encode = function utf8_encode(string) {
        // http://kevin.vanzonneveld.net
    ...
    HasherUtils.md5_vm_test = function md5_vm_test() {
    ...
    HasherUtils.core_md5 = function core_md5(x, len) {
        /* append padding */
        x[len >> 5] |= 0x80 << len % 32;
        x[(len + 64 >>> 9 << 4) + 14] = len;
    ...
    HasherUtils.md5_cmn = function md5_cmn(q, a, b, x, s, t) {
    ...
    HasherUtils.md5_ff = function md5_ff(a, b, c, d, x, s, t) {
        return HasherUtils.md5_cmn(b & c | ~b & d, a, b, x, s, t);
    };

    HasherUtils.md5_gg = function md5_gg(a, b, c, d, x, s, t) {
        return HasherUtils.md5_cmn(b & d | c & ~d, a, b, x, s, t);
    };

    HasherUtils.md5_hh = function md5_hh(a, b, c, d, x, s, t) {
        return HasherUtils.md5_cmn(b ^ c ^ d, a, b, x, s, t);
    };

    HasherUtils.md5_ii = function md5_ii(a, b, c, d, x, s, t) {
    ...
    HasherUtils.core_hmac_md5 = function core_hmac_md5(key, data) {
    ...
    HasherUtils.safe_add = function safe_add(x, y) {
    ...
    HasherUtils.bit_rol = function bit_rol(num, cnt) {
    ...
    HasherUtils.str2binl = function str2binl(str) {
        var bin = [];
    ...
    HasherUtils.binl2str = function binl2str(bin) {
        var str = "";
        var mask = (1 << HasherUtils.chrsz) - 1;
    ...
    HasherUtils.binl2hex = function binl2hex(binarray) {
    ...
    HasherUtils.binl2b64 = function binl2b64(binarray) {
        var tab = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
        var str = "";
        for (var i = 0; i < binarray.length * 4; i += 3) {
            var triplet = (binarray[i >> 2] >> 8 * (i % 4) & 0xFF) << 16 | (binarray[i + 1 >> 2] >> 8 * ((i + 1) % 4) & 0xFF) << 8 | binarray[i + 2 >> 2] >> 8 * ((i + 2) % 4) & 0xFF;
            for (var j = 0; j < 4; j++) {
                if (i * 8 + j * 6 > binarray.length * 32) str += HasherUtils.b64pad;else str += tab.charAt(triplet >> 6 * (3 - j) & 0x3F);
            }
        }
        return str;
    };
