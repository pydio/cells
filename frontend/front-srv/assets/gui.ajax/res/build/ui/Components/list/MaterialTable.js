...
var MaterialTable = (function (_React$Component) {
    ...
    MaterialTable.prototype.render = function render() {
        ...
        if (actionsColumn) {
            headers.push(_react2['default'].createElement(_materialUi.TableHeaderColumn, { style: _extends({ width: 48 * actions.length + 32, height: 48, backgroundColor: '#F5F5F5' }, masterStyles.head) }));
        }
...
MaterialTable.PropTypes = {
    ...
    onSelectRows: _propTypes2['default'].func,
    emptyStateString: _propTypes2['default'].string
};
