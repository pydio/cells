		...
		case "jobs.TriggerFilterQuery":
			...
			eventsField := &forms.FormField{
				...
				ChoicePresetList: []map[string]string{
					{jobs.NodeChangeEventName(tree.NodeChangeEvent_CREATE): "Create N"},
					{jobs.NodeChangeEventName(tree.NodeChangeEvent_READ): "Read N"},
					{jobs.NodeChangeEventName(tree.NodeChangeEvent_DELETE): "Delete N"},
					{jobs.NodeChangeEventName(tree.NodeChangeEvent_UPDATE_PATH): "Move N"},
