...
require (
	...
	github.com/minio/minio v0.0.0-20251106103816-58659f26f45f
...
require (
	...
	github.com/gobuffalo/plush/v5 v5.0.9 // indirect
...
replace github.com/minio/minio => github.com/pydio/minio v0.0.0-20251127102432-d3b575770589
