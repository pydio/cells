...
CREATE TABLE IF NOT EXISTS legacy_enc_nodes (
    node_id VARCHAR(255) NOT NULL PRIMARY KEY,
    nonce BLOB,
    block_size INT
);

INSERT INTO legacy_enc_nodes (node_id, nonce, block_size) (SELECT DISTINCT node_id, nonce, block_size FROM enc_nodes);
