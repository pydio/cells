...
main:
	go build -a -ldflags "-X github.com/pydio/cells/common.version=${CELLS_VERSION} -X github.com/pydio/cells/common.BuildStamp=`date -u +%Y-%m-%dT%H:%M:%S` -X github.com/pydio/cells/common.BuildRevision=`git rev-parse HEAD`" -o cells main.go
