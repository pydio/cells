...
const file_cellsapi_idm_proto_rawDesc = "" +
	"\n" +
	"\x12cellsapi-idm.proto\x12\x04rest\x1a\x0fcells-idm.proto\x1a\x13cells-service.proto\"\x9d\x01\n" +
	"\x13ResourcePolicyQuery\x127\n" +
	"\x04Type\x18\x01 \x01(\x0e2#.rest.ResourcePolicyQuery.QueryTypeR\x04Type\x12\x16\n" +
	"\x06UserId\x18\x02 \x01(\tR\x06UserId\"5\n" +
	"\tQueryType\x12\v\n" +
	"\aCONTEXT\x10\x00\x12\a\n" +
	"\x03ANY\x10\x01\x12\b\n" +
	"\x04NONE\x10\x02\x12\b\n" +
	"\x04USER\x10\x03\"\xac\x02\n" +
	"\x11SearchRoleRequest\x12.\n" +
	"\aQueries\x18\x01 \x03(\v2\x14.idm.RoleSingleQueryR\aQueries\x12K\n" +
	"\x13ResourcePolicyQuery\x18\a \x01(\v2\x19.rest.ResourcePolicyQueryR\x13ResourcePolicyQuery\x12\x16\n" +
	"\x06Offset\x18\x02 \x01(\x03R\x06Offset\x12\x14\n" +
	"\x05Limit\x18\x03 \x01(\x03R\x05Limit\x12\x18\n" +
	"\aGroupBy\x18\x04 \x01(\x05R\aGroupBy\x12\x1c\n" +
	"\tCountOnly\x18\x05 \x01(\bR\tCountOnly\x124\n" +
	"\tOperation\x18\x06 \x01(\x0e2\x16.service.OperationTypeR\tOperation\"H\n" +
	"\x0fRolesCollection\x12\x1f\n" +
	"\x05Roles\x18\x01 \x03(\v2\t.idm.RoleR\x05Roles\x12\x14\n" +
	"\x05Total\x18\x02 \x01(\x05R\x05Total\"\xac\x02\n" +
	"\x11SearchUserRequest\x12.\n" +
	"\aQueries\x18\x01 \x03(\v2\x14.idm.UserSingleQueryR\aQueries\x12K\n" +
	"\x13ResourcePolicyQuery\x18\a \x01(\v2\x19.rest.ResourcePolicyQueryR\x13ResourcePolicyQuery\x12\x16\n" +
	"\x06Offset\x18\x02 \x01(\x03R\x06Offset\x12\x14\n" +
	"\x05Limit\x18\x03 \x01(\x03R\x05Limit\x12\x18\n" +
	"\aGroupBy\x18\x04 \x01(\x05R\aGroupBy\x12\x1c\n" +
	"\tCountOnly\x18\x05 \x01(\bR\tCountOnly\x124\n" +
	"\tOperation\x18\x06 \x01(\x0e2\x16.service.OperationTypeR\tOperation\"k\n" +
	"\x0fUsersCollection\x12!\n" +
	"\x06Groups\x18\x01 \x03(\v2\t.idm.UserR\x06Groups\x12\x1f\n" +
	"\x05Users\x18\x02 \x03(\v2\t.idm.UserR\x05Users\x12\x14\n" +
	"\x05Total\x18\x03 \x01(\x05R\x05Total\"(\n" +
	"\fBindResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\"\xdd\x01\n" +
	"\x10SearchACLRequest\x12-\n" +
	"\aQueries\x18\x01 \x03(\v2\x13.idm.ACLSingleQueryR\aQueries\x12\x16\n" +
	"\x06Offset\x18\x02 \x01(\x03R\x06Offset\x12\x14\n" +
	"\x05Limit\x18\x03 \x01(\x03R\x05Limit\x12\x18\n" +
	"\aGroupBy\x18\x04 \x01(\x05R\aGroupBy\x12\x1c\n" +
	"\tCountOnly\x18\x05 \x01(\bR\tCountOnly\x124\n" +
	"\tOperation\x18\x06 \x01(\x0e2\x16.service.OperationTypeR\tOperation\"C\n" +
	"\rACLCollection\x12\x1c\n" +
	"\x04ACLs\x18\x01 \x03(\v2\b.idm.ACLR\x04ACLs\x12\x14\n" +
	"\x05Total\x18\x02 \x01(\x05R\x05Total\"\xb6\x02\n" +
	"\x16SearchWorkspaceRequest\x123\n" +
	"\aQueries\x18\x01 \x03(\v2\x19.idm.WorkspaceSingleQueryR\aQueries\x12K\n" +
	"\x13ResourcePolicyQuery\x18\a \x01(\v2\x19.rest.ResourcePolicyQueryR\x13ResourcePolicyQuery\x12\x16\n" +
	"\x06Offset\x18\x02 \x01(\x03R\x06Offset\x12\x14\n" +
	"\x05Limit\x18\x03 \x01(\x03R\x05Limit\x12\x18\n" +
	"\aGroupBy\x18\x04 \x01(\x05R\aGroupBy\x12\x1c\n" +
	"\tCountOnly\x18\x05 \x01(\bR\tCountOnly\x124\n" +
	"\tOperation\x18\x06 \x01(\x0e2\x16.service.OperationTypeR\tOperation\"[\n" +
	"\x13WorkspaceCollection\x12.\n" +
	"\n" +
	"Workspaces\x18\x01 \x03(\v2\x0e.idm.WorkspaceR\n" +
	"Workspaces\x12\x14\n" +
	"\x05Total\x18\x02 \x01(\x05R\x05Total\"A\n" +
	"\x12UserMetaCollection\x12+\n" +
	"\tMetadatas\x18\x01 \x03(\v2\r.idm.UserMetaR\tMetadatas\"U\n" +
	"\x1bUserMetaNamespaceCollection\x126\n" +
	"\n" +
	"Namespaces\x18\x01 \x03(\v2\x16.idm.UserMetaNamespaceR\n" +
	"Namespaces\"7\n" +
	"\x17ListUserMetaTagsRequest\x12\x1c\n" +
	"\tNamespace\x18\x01 \x01(\tR\tNamespace\".\n" +
	"\x18ListUserMetaTagsResponse\x12\x12\n" +
	"\x04Tags\x18\x01 \x03(\tR\x04Tags\"G\n" +
	"\x15PutUserMetaTagRequest\x12\x1c\n" +
	"\tNamespace\x18\x01 \x01(\tR\tNamespace\x12\x10\n" +
	"\x03Tag\x18\x02 \x01(\tR\x03Tag\"2\n" +
	"\x16PutUserMetaTagResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\"M\n" +
	"\x19DeleteUserMetaTagsRequest\x12\x1c\n" +
	"\tNamespace\x18\x01 \x01(\tR\tNamespace\x12\x12\n" +
	"\x04Tags\x18\x02 \x01(\tR\x04Tags\"6\n" +
	"\x1aDeleteUserMetaTagsResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\"5\n" +
	"\x15GetFieldSchemaRequest\x12\x1c\n" +
	"\tFieldType\x18\x01 \x01(\tR\tFieldType\"0\n" +
	"\x16GetFieldSchemaResponse\x12\x16\n" +
	"\x06Schema\x18\x01 \x01(\tR\x06Schema\"(\n" +
	"\x14UserBookmarksRequest\x12\x10\n" +
	...
	"\x19ResetPasswordTokenRequest\x12\x1c\n" +
	"\tUserLogin\x18\x01 \x01(\tR\tUserLogin\x12\x16\n" +
	"\x06Create\x18\x02 \x01(\bR\x06Create\"P\n" +
	"\x1aResetPasswordTokenResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\x12\x18\n" +
	"\aMessage\x18\x02 \x01(\tR\aMessage\"\x86\x01\n" +
	"\x14ResetPasswordRequest\x12.\n" +
	"\x12ResetPasswordToken\x18\x01 \x01(\tR\x12ResetPasswordToken\x12\x1c\n" +
	"\tUserLogin\x18\x02 \x01(\tR\tUserLogin\x12 \n" +
	"\vNewPassword\x18\x03 \x01(\tR\vNewPassword\"K\n" +
	"\x15ResetPasswordResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\x12\x18\n" +
	"\aMessage\x18\x02 \x01(\tR\aMessage\"L\n" +
	"\x1aDocumentAccessTokenRequest\x12\x12\n" +
	"\x04Path\x18\x01 \x01(\tR\x04Path\x12\x1a\n" +
	"\bClientID\x18\x02 \x01(\tR\bClientID\"?\n" +
	"\x1bDocumentAccessTokenResponse\x12 \n" +
	"\vAccessToken\x18\x01 \x01(\tR\vAccessTokenB-Z+github.com/pydio/cells/v5/common/proto/restb\x06proto3"

var (
	file_cellsapi_idm_proto_rawDescOnce sync.Once
	file_cellsapi_idm_proto_rawDescData []byte
)

func file_cellsapi_idm_proto_rawDescGZIP() []byte {
	file_cellsapi_idm_proto_rawDescOnce.Do(func() {
		file_cellsapi_idm_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cellsapi_idm_proto_rawDesc), len(file_cellsapi_idm_proto_rawDesc)))
	})
...
func file_cellsapi_idm_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cellsapi_idm_proto_rawDesc), len(file_cellsapi_idm_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   29,
			NumExtensions: 0,
			NumServices:   0,
