...
func file_cellsapi_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cellsapi_graph_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cellsapi_graph_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
