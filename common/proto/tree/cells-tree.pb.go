...
func (x *SearchResponse) GetNode() *Node {
	if x, ok := x.GetData().(*SearchResponse_Node); ok {
		return x.Node
	}
	return nil
}
...
func (x *SearchResponse) GetFacet() *SearchFacet {
	if x, ok := x.GetData().(*SearchResponse_Facet); ok {
		return x.Facet
	}
	return nil
}
...
func (x *SearchResponse) GetPagination() *SearchPagination {
	if x, ok := x.GetData().(*SearchResponse_Pagination); ok {
		return x.Pagination
	}
	return nil
}
...
func file_cells_tree_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cells_tree_proto_msgTypes[56].Exporter = func(v any, i int) any {
