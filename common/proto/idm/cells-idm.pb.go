...
var file_cells_idm_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0xd5,
	0x02, 0x0a, 0x13, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x53,
	...
	0x12, 0x54, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x1d, 0x2e, 0x69, 0x64, 0x6d, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x69, 0x64, 0x6d, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74,
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x64,
...
var file_cells_idm_proto_depIdxs = []int32{
	...
	66, // 92: idm.PolicyEngineService.DeletePolicyGroup:input_type -> idm.DeletePolicyGroupRequest
	8,  // 93: idm.RoleService.CreateRole:output_type -> idm.CreateRoleResponse
	10, // 94: idm.RoleService.DeleteRole:output_type -> idm.DeleteRoleResponse
	12, // 95: idm.RoleService.SearchRole:output_type -> idm.SearchRoleResponse
	12, // 96: idm.RoleService.StreamRole:output_type -> idm.SearchRoleResponse
	13, // 97: idm.RoleService.CountRole:output_type -> idm.CountRoleResponse
	17, // 98: idm.UserService.CreateUser:output_type -> idm.CreateUserResponse
	21, // 99: idm.UserService.DeleteUser:output_type -> idm.DeleteUserResponse
	19, // 100: idm.UserService.BindUser:output_type -> idm.BindUserResponse
	24, // 101: idm.UserService.CountUser:output_type -> idm.CountUserResponse
	23, // 102: idm.UserService.SearchUser:output_type -> idm.SearchUserResponse
	23, // 103: idm.UserService.StreamUser:output_type -> idm.SearchUserResponse
	28, // 104: idm.WorkspaceService.CreateWorkspace:output_type -> idm.CreateWorkspaceResponse
	30, // 105: idm.WorkspaceService.DeleteWorkspace:output_type -> idm.DeleteWorkspaceResponse
	32, // 106: idm.WorkspaceService.SearchWorkspace:output_type -> idm.SearchWorkspaceResponse
	32, // 107: idm.WorkspaceService.StreamWorkspace:output_type -> idm.SearchWorkspaceResponse
	36, // 108: idm.ACLService.CreateACL:output_type -> idm.CreateACLResponse
	38, // 109: idm.ACLService.ExpireACL:output_type -> idm.ExpireACLResponse
	40, // 110: idm.ACLService.DeleteACL:output_type -> idm.DeleteACLResponse
	42, // 111: idm.ACLService.SearchACL:output_type -> idm.SearchACLResponse
	42, // 112: idm.ACLService.StreamACL:output_type -> idm.SearchACLResponse
	44, // 113: idm.ACLService.RestoreACL:output_type -> idm.RestoreACLResponse
	51, // 114: idm.UserMetaService.UpdateUserMeta:output_type -> idm.UpdateUserMetaResponse
	53, // 115: idm.UserMetaService.SearchUserMeta:output_type -> idm.SearchUserMetaResponse
	55, // 116: idm.UserMetaService.UpdateUserMetaNamespace:output_type -> idm.UpdateUserMetaNamespaceResponse
	57, // 117: idm.UserMetaService.ListUserMetaNamespace:output_type -> idm.ListUserMetaNamespaceResponse
	60, // 118: idm.PolicyEngineService.IsAllowed:output_type -> idm.PolicyEngineResponse
	65, // 119: idm.PolicyEngineService.StorePolicyGroup:output_type -> idm.StorePolicyGroupResponse
	69, // 120: idm.PolicyEngineService.ListPolicyGroups:output_type -> idm.ListPolicyGroupsResponse
	67, // 121: idm.PolicyEngineService.DeletePolicyGroup:output_type -> idm.DeletePolicyGroupResponse
