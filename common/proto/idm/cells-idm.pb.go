...
func (UpdateUserMetaNamespaceRequest_UserMetaNsOp) EnumDescriptor() ([]byte, []int) {
	return file_cells_idm_proto_rawDescGZIP(), []int{54, 0}
}
...
type GetMetaEntityValuesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetMetaEntityValuesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type MetaEntityValueResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EntityValue   []*EntityValue         `protobuf:"bytes,1,rep,name=EntityValue,proto3" json:"EntityValue,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetaEntityValueResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_cells_idm_proto_rawDesc = "" +
	...
	"EntityUuid\"M\n" +
	"\x17MetaEntityValueResponse\x122\n" +
	"\vEntityValue\x18\x01 \x03(\v2\x10.idm.EntityValueR\vEntityValue\"\x95\x02\n" +
	"\bUserMeta\x12\x12\n" +
	...
	"\n" +
	"RestoreACL\x12\x16.idm.RestoreACLRequest\x1a\x17.idm.RestoreACLResponse\"\x002\xc1\x05\n" +
	...
	"\x0fGetEntityValues\x12\x1f.idm.GetMetaEntityValuesRequest\x1a\x1c.idm.MetaEntityValueResponse\"\x00\x12X\n" +
	"\x12DeleteEntityValues\x12\x1f.idm.GetMetaEntityValuesRequest\x1a\x1f.idm.DeleteEntityValuesResponse\"\x002\x9f\x03\n" +
...
var file_cells_idm_proto_msgTypes = make([]protoimpl.MessageInfo, 87)
var file_cells_idm_proto_goTypes = []any{
	...
	(*DeleteEntityValuesResponse)(nil),               // 50: idm.DeleteEntityValuesResponse
	(*GetMetaEntityValuesRequest)(nil),               // 51: idm.GetMetaEntityValuesRequest
	(*MetaEntityValueResponse)(nil),                  // 52: idm.MetaEntityValueResponse
	(*UserMeta)(nil),                                 // 53: idm.UserMeta
	(*UserMetaNamespace)(nil),                        // 54: idm.UserMetaNamespace
	(*MetaEntity)(nil),                               // 55: idm.MetaEntity
	(*EntityValue)(nil),                              // 56: idm.EntityValue
	(*UpdateUserMetaRequest)(nil),                    // 57: idm.UpdateUserMetaRequest
	(*UpdateUserMetaResponse)(nil),                   // 58: idm.UpdateUserMetaResponse
	(*UpdateUserMetaEvent)(nil),                      // 59: idm.UpdateUserMetaEvent
	(*SearchUserMetaRequest)(nil),                    // 60: idm.SearchUserMetaRequest
	(*SearchUserMetaResponse)(nil),                   // 61: idm.SearchUserMetaResponse
	(*UpdateUserMetaNamespaceRequest)(nil),           // 62: idm.UpdateUserMetaNamespaceRequest
	(*UpdateUserMetaNamespaceResponse)(nil),          // 63: idm.UpdateUserMetaNamespaceResponse
	(*ListUserMetaNamespaceRequest)(nil),             // 64: idm.ListUserMetaNamespaceRequest
	(*ListUserMetaNamespaceResponse)(nil),            // 65: idm.ListUserMetaNamespaceResponse
	(*GetFieldSchemaRequest)(nil),                    // 66: idm.GetFieldSchemaRequest
	(*JsonSchemaResponse)(nil),                       // 67: idm.JsonSchemaResponse
	(*GetNamespaceSchemaRequest)(nil),                // 68: idm.GetNamespaceSchemaRequest
	(*ChangeEvent)(nil),                              // 69: idm.ChangeEvent
	(*PolicyEngineRequest)(nil),                      // 70: idm.PolicyEngineRequest
	(*PolicyEngineResponse)(nil),                     // 71: idm.PolicyEngineResponse
	(*PolicyCondition)(nil),                          // 72: idm.PolicyCondition
	(*Policy)(nil),                                   // 73: idm.Policy
	(*PolicySubject)(nil),                            // 74: idm.PolicySubject
	(*PolicyResource)(nil),                           // 75: idm.PolicyResource
	(*PolicyAction)(nil),                             // 76: idm.PolicyAction
	(*PolicyResourceRel)(nil),                        // 77: idm.PolicyResourceRel
	(*PolicySubjectRel)(nil),                         // 78: idm.PolicySubjectRel
	(*PolicyActionRel)(nil),                          // 79: idm.PolicyActionRel
	(*PolicyRel)(nil),                                // 80: idm.PolicyRel
	(*PolicyGroup)(nil),                              // 81: idm.PolicyGroup
	(*StorePolicyGroupRequest)(nil),                  // 82: idm.StorePolicyGroupRequest
	(*StorePolicyGroupResponse)(nil),                 // 83: idm.StorePolicyGroupResponse
	(*DeletePolicyGroupRequest)(nil),                 // 84: idm.DeletePolicyGroupRequest
	(*DeletePolicyGroupResponse)(nil),                // 85: idm.DeletePolicyGroupResponse
	(*ListPolicyGroupsRequest)(nil),                  // 86: idm.ListPolicyGroupsRequest
	(*ListPolicyGroupsResponse)(nil),                 // 87: idm.ListPolicyGroupsResponse
	(*PolicyGroupSingleQuery)(nil),                   // 88: idm.PolicyGroupSingleQuery
	nil,                                              // 89: idm.User.AttributesEntry
	nil,                                              // 90: idm.Workspace.RootNodesEntry
	nil,                                              // 91: idm.UpdateUserMetaEvent.EventMetadataEntry
	nil,                                              // 92: idm.ChangeEvent.AttributesEntry
	nil,                                              // 93: idm.PolicyEngineRequest.ContextEntry
	nil,                                              // 94: idm.Policy.ConditionsEntry
	(*service.Query)(nil),                            // 95: service.Query
	(*service.ResourcePolicy)(nil),                   // 96: service.ResourcePolicy
	(*tree.TreeNode)(nil),                            // 97: tree.TreeNode
	(*tree.Node)(nil),                                // 98: tree.Node
	(*structpb.Struct)(nil),                          // 99: google.protobuf.Struct
	(*service.ResourcePolicyQuery)(nil),              // 100: service.ResourcePolicyQuery
}
var file_cells_idm_proto_depIdxs = []int32{
	...
	95,  // 2: idm.DeleteRoleRequest.Query:type_name -> service.Query
	95,  // 3: idm.SearchRoleRequest.Query:type_name -> service.Query
	15,  // 4: idm.SearchRoleResponse.Role:type_name -> idm.Role
	96,  // 5: idm.Role.Policies:type_name -> service.ResourcePolicy
	...
	95,  // 9: idm.DeleteUserRequest.Query:type_name -> service.Query
	95,  // 10: idm.SearchUserRequest.Query:type_name -> service.Query
	27,  // 11: idm.SearchUserResponse.User:type_name -> idm.User
	97,  // 12: idm.TreeUser.node:type_name -> tree.TreeNode
	27,  // 13: idm.TreeUser.user:type_name -> idm.User
	89,  // 14: idm.User.Attributes:type_name -> idm.User.AttributesEntry
	15,  // 15: idm.User.Roles:type_name -> idm.Role
	96,  // 16: idm.User.Policies:type_name -> service.ResourcePolicy
	...
	95,  // 20: idm.DeleteWorkspaceRequest.Query:type_name -> service.Query
	95,  // 21: idm.SearchWorkspaceRequest.Query:type_name -> service.Query
	35,  // 22: idm.SearchWorkspaceResponse.Workspace:type_name -> idm.Workspace
	1,   // 23: idm.Workspace.Scope:type_name -> idm.WorkspaceScope
	96,  // 24: idm.Workspace.Policies:type_name -> service.ResourcePolicy
	90,  // 25: idm.Workspace.RootNodes:type_name -> idm.Workspace.RootNodesEntry
	...
	95,  // 31: idm.ExpireACLRequest.Query:type_name -> service.Query
	95,  // 32: idm.DeleteACLRequest.Query:type_name -> service.Query
	95,  // 33: idm.SearchACLRequest.Query:type_name -> service.Query
	48,  // 34: idm.SearchACLResponse.ACL:type_name -> idm.ACL
	95,  // 35: idm.RestoreACLRequest.Query:type_name -> service.Query
	47,  // 36: idm.ACL.Action:type_name -> idm.ACLAction
	47,  // 37: idm.ACLSingleQuery.Actions:type_name -> idm.ACLAction
	56,  // 38: idm.MetaEntityValueResponse.EntityValue:type_name -> idm.EntityValue
	96,  // 39: idm.UserMeta.Policies:type_name -> service.ResourcePolicy
	98,  // 40: idm.UserMeta.ResolvedNode:type_name -> tree.Node
	96,  // 41: idm.UserMetaNamespace.Policies:type_name -> service.ResourcePolicy
	99,  // 42: idm.UserMetaNamespace.JsonSchema:type_name -> google.protobuf.Struct
	5,   // 43: idm.UpdateUserMetaRequest.Operation:type_name -> idm.UpdateUserMetaRequest.UserMetaOp
	53,  // 44: idm.UpdateUserMetaRequest.MetaDatas:type_name -> idm.UserMeta
	53,  // 45: idm.UpdateUserMetaResponse.MetaDatas:type_name -> idm.UserMeta
	91,  // 46: idm.UpdateUserMetaEvent.EventMetadata:type_name -> idm.UpdateUserMetaEvent.EventMetadataEntry
	6,   // 47: idm.UpdateUserMetaEvent.Operation:type_name -> idm.UpdateUserMetaEvent.UserMetaOp
	53,  // 48: idm.UpdateUserMetaEvent.UserMeta:type_name -> idm.UserMeta
	100, // 49: idm.SearchUserMetaRequest.ResourceQuery:type_name -> service.ResourcePolicyQuery
	53,  // 50: idm.SearchUserMetaResponse.UserMeta:type_name -> idm.UserMeta
	7,   // 51: idm.UpdateUserMetaNamespaceRequest.Operation:type_name -> idm.UpdateUserMetaNamespaceRequest.UserMetaNsOp
	54,  // 52: idm.UpdateUserMetaNamespaceRequest.Namespaces:type_name -> idm.UserMetaNamespace
	54,  // 53: idm.UpdateUserMetaNamespaceResponse.Namespaces:type_name -> idm.UserMetaNamespace
	54,  // 54: idm.ListUserMetaNamespaceResponse.UserMetaNamespace:type_name -> idm.UserMetaNamespace
	99,  // 55: idm.JsonSchemaResponse.JsonSchema:type_name -> google.protobuf.Struct
	2,   // 56: idm.ChangeEvent.Type:type_name -> idm.ChangeEventType
	27,  // 57: idm.ChangeEvent.User:type_name -> idm.User
	15,  // 58: idm.ChangeEvent.Role:type_name -> idm.Role
	35,  // 59: idm.ChangeEvent.Workspace:type_name -> idm.Workspace
	48,  // 60: idm.ChangeEvent.Acl:type_name -> idm.ACL
	54,  // 61: idm.ChangeEvent.MetaNamespace:type_name -> idm.UserMetaNamespace
	92,  // 62: idm.ChangeEvent.Attributes:type_name -> idm.ChangeEvent.AttributesEntry
	93,  // 63: idm.PolicyEngineRequest.Context:type_name -> idm.PolicyEngineRequest.ContextEntry
	74,  // 64: idm.Policy.OrmSubjects:type_name -> idm.PolicySubject
	75,  // 65: idm.Policy.OrmResources:type_name -> idm.PolicyResource
	76,  // 66: idm.Policy.OrmActions:type_name -> idm.PolicyAction
	3,   // 67: idm.Policy.Effect:type_name -> idm.PolicyEffect
	94,  // 68: idm.Policy.Conditions:type_name -> idm.Policy.ConditionsEntry
	4,   // 69: idm.PolicyGroup.ResourceGroup:type_name -> idm.PolicyResourceGroup
	73,  // 70: idm.PolicyGroup.Policies:type_name -> idm.Policy
	81,  // 71: idm.StorePolicyGroupRequest.PolicyGroup:type_name -> idm.PolicyGroup
	81,  // 72: idm.StorePolicyGroupResponse.PolicyGroup:type_name -> idm.PolicyGroup
	81,  // 73: idm.DeletePolicyGroupRequest.PolicyGroup:type_name -> idm.PolicyGroup
	95,  // 74: idm.ListPolicyGroupsRequest.Query:type_name -> service.Query
	81,  // 75: idm.ListPolicyGroupsResponse.PolicyGroups:type_name -> idm.PolicyGroup
	98,  // 76: idm.Workspace.RootNodesEntry.value:type_name -> tree.Node
	72,  // 77: idm.Policy.ConditionsEntry.value:type_name -> idm.PolicyCondition
	8,   // 78: idm.RoleService.CreateRole:input_type -> idm.CreateRoleRequest
	10,  // 79: idm.RoleService.DeleteRole:input_type -> idm.DeleteRoleRequest
	12,  // 80: idm.RoleService.SearchRole:input_type -> idm.SearchRoleRequest
	12,  // 81: idm.RoleService.StreamRole:input_type -> idm.SearchRoleRequest
	12,  // 82: idm.RoleService.CountRole:input_type -> idm.SearchRoleRequest
	17,  // 83: idm.UserService.CreateUser:input_type -> idm.CreateUserRequest
	21,  // 84: idm.UserService.DeleteUser:input_type -> idm.DeleteUserRequest
	19,  // 85: idm.UserService.BindUser:input_type -> idm.BindUserRequest
	23,  // 86: idm.UserService.CountUser:input_type -> idm.SearchUserRequest
	23,  // 87: idm.UserService.SearchOne:input_type -> idm.SearchUserRequest
	23,  // 88: idm.UserService.SearchUser:input_type -> idm.SearchUserRequest
	23,  // 89: idm.UserService.StreamUser:input_type -> idm.SearchUserRequest
	29,  // 90: idm.WorkspaceService.CreateWorkspace:input_type -> idm.CreateWorkspaceRequest
	31,  // 91: idm.WorkspaceService.DeleteWorkspace:input_type -> idm.DeleteWorkspaceRequest
	33,  // 92: idm.WorkspaceService.SearchWorkspace:input_type -> idm.SearchWorkspaceRequest
	33,  // 93: idm.WorkspaceService.StreamWorkspace:input_type -> idm.SearchWorkspaceRequest
	37,  // 94: idm.ACLService.CreateACL:input_type -> idm.CreateACLRequest
	39,  // 95: idm.ACLService.ExpireACL:input_type -> idm.ExpireACLRequest
	41,  // 96: idm.ACLService.DeleteACL:input_type -> idm.DeleteACLRequest
	43,  // 97: idm.ACLService.SearchACL:input_type -> idm.SearchACLRequest
	43,  // 98: idm.ACLService.StreamACL:input_type -> idm.SearchACLRequest
	45,  // 99: idm.ACLService.RestoreACL:input_type -> idm.RestoreACLRequest
	57,  // 100: idm.UserMetaService.UpdateUserMeta:input_type -> idm.UpdateUserMetaRequest
	60,  // 101: idm.UserMetaService.SearchUserMeta:input_type -> idm.SearchUserMetaRequest
	62,  // 102: idm.UserMetaService.UpdateUserMetaNamespace:input_type -> idm.UpdateUserMetaNamespaceRequest
	64,  // 103: idm.UserMetaService.ListUserMetaNamespace:input_type -> idm.ListUserMetaNamespaceRequest
	66,  // 104: idm.UserMetaService.GetFieldSchema:input_type -> idm.GetFieldSchemaRequest
	68,  // 105: idm.UserMetaService.GetNamespaceSchema:input_type -> idm.GetNamespaceSchemaRequest
	51,  // 106: idm.UserMetaService.GetEntityValues:input_type -> idm.GetMetaEntityValuesRequest
	51,  // 107: idm.UserMetaService.DeleteEntityValues:input_type -> idm.GetMetaEntityValuesRequest
	70,  // 108: idm.PolicyEngineService.IsAllowed:input_type -> idm.PolicyEngineRequest
	82,  // 109: idm.PolicyEngineService.StorePolicyGroup:input_type -> idm.StorePolicyGroupRequest
	86,  // 110: idm.PolicyEngineService.ListPolicyGroups:input_type -> idm.ListPolicyGroupsRequest
	86,  // 111: idm.PolicyEngineService.StreamPolicyGroups:input_type -> idm.ListPolicyGroupsRequest
	84,  // 112: idm.PolicyEngineService.DeletePolicyGroup:input_type -> idm.DeletePolicyGroupRequest
	9,   // 113: idm.RoleService.CreateRole:output_type -> idm.CreateRoleResponse
	11,  // 114: idm.RoleService.DeleteRole:output_type -> idm.DeleteRoleResponse
	13,  // 115: idm.RoleService.SearchRole:output_type -> idm.SearchRoleResponse
	13,  // 116: idm.RoleService.StreamRole:output_type -> idm.SearchRoleResponse
	14,  // 117: idm.RoleService.CountRole:output_type -> idm.CountRoleResponse
	18,  // 118: idm.UserService.CreateUser:output_type -> idm.CreateUserResponse
	22,  // 119: idm.UserService.DeleteUser:output_type -> idm.DeleteUserResponse
	20,  // 120: idm.UserService.BindUser:output_type -> idm.BindUserResponse
	25,  // 121: idm.UserService.CountUser:output_type -> idm.CountUserResponse
	24,  // 122: idm.UserService.SearchOne:output_type -> idm.SearchUserResponse
	24,  // 123: idm.UserService.SearchUser:output_type -> idm.SearchUserResponse
	24,  // 124: idm.UserService.StreamUser:output_type -> idm.SearchUserResponse
	30,  // 125: idm.WorkspaceService.CreateWorkspace:output_type -> idm.CreateWorkspaceResponse
	32,  // 126: idm.WorkspaceService.DeleteWorkspace:output_type -> idm.DeleteWorkspaceResponse
	34,  // 127: idm.WorkspaceService.SearchWorkspace:output_type -> idm.SearchWorkspaceResponse
	34,  // 128: idm.WorkspaceService.StreamWorkspace:output_type -> idm.SearchWorkspaceResponse
	38,  // 129: idm.ACLService.CreateACL:output_type -> idm.CreateACLResponse
	40,  // 130: idm.ACLService.ExpireACL:output_type -> idm.ExpireACLResponse
	42,  // 131: idm.ACLService.DeleteACL:output_type -> idm.DeleteACLResponse
	44,  // 132: idm.ACLService.SearchACL:output_type -> idm.SearchACLResponse
	44,  // 133: idm.ACLService.StreamACL:output_type -> idm.SearchACLResponse
	46,  // 134: idm.ACLService.RestoreACL:output_type -> idm.RestoreACLResponse
	58,  // 135: idm.UserMetaService.UpdateUserMeta:output_type -> idm.UpdateUserMetaResponse
	61,  // 136: idm.UserMetaService.SearchUserMeta:output_type -> idm.SearchUserMetaResponse
	63,  // 137: idm.UserMetaService.UpdateUserMetaNamespace:output_type -> idm.UpdateUserMetaNamespaceResponse
	65,  // 138: idm.UserMetaService.ListUserMetaNamespace:output_type -> idm.ListUserMetaNamespaceResponse
	67,  // 139: idm.UserMetaService.GetFieldSchema:output_type -> idm.JsonSchemaResponse
	67,  // 140: idm.UserMetaService.GetNamespaceSchema:output_type -> idm.JsonSchemaResponse
	52,  // 141: idm.UserMetaService.GetEntityValues:output_type -> idm.MetaEntityValueResponse
	50,  // 142: idm.UserMetaService.DeleteEntityValues:output_type -> idm.DeleteEntityValuesResponse
	71,  // 143: idm.PolicyEngineService.IsAllowed:output_type -> idm.PolicyEngineResponse
	83,  // 144: idm.PolicyEngineService.StorePolicyGroup:output_type -> idm.StorePolicyGroupResponse
	87,  // 145: idm.PolicyEngineService.ListPolicyGroups:output_type -> idm.ListPolicyGroupsResponse
	81,  // 146: idm.PolicyEngineService.StreamPolicyGroups:output_type -> idm.PolicyGroup
	85,  // 147: idm.PolicyEngineService.DeletePolicyGroup:output_type -> idm.DeletePolicyGroupResponse
