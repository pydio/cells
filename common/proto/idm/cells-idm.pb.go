...
type LinkMetaToEntityValueRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MetaUuid        string                 `protobuf:"bytes,1,opt,name=MetaUuid,proto3" json:"MetaUuid,omitempty"`
	EntityValueUuid string                 `protobuf:"bytes,2,opt,name=EntityValueUuid,proto3" json:"EntityValueUuid,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *LinkMetaToEntityValueRequest) Reset() {
	*x = LinkMetaToEntityValueRequest{}
	mi := &file_cells_idm_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LinkMetaToEntityValueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LinkMetaToEntityValueRequest) ProtoMessage() {}

func (x *LinkMetaToEntityValueRequest) ProtoReflect() protoreflect.Message {
	mi := &file_cells_idm_proto_msgTypes[42]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LinkMetaToEntityValueRequest.ProtoReflect.Descriptor instead.
func (*LinkMetaToEntityValueRequest) Descriptor() ([]byte, []int) {
	return file_cells_idm_proto_rawDescGZIP(), []int{42}
}

func (x *LinkMetaToEntityValueRequest) GetMetaUuid() string {
	if x != nil {
		return x.MetaUuid
	}
	return ""
...
func (x *LinkMetaToEntityValueRequest) GetEntityValueUuid() string {
	if x != nil {
...
// Added to enable linking metadata to fetch meta UUID for EntityValue association
...
func (x *GetMetadataRequest) GetNodeUuid() string {
	if x != nil {
		return x.NodeUuid
	}
	return ""
...
// Creates a new Entity representing a metadata field (e.g. "Department", "Project") and its possible values
...
// Response of CreateEntityValueRequest, returns the list of created EntityValues with their UUIDs
...
// Response of CreateEntityRequest, returns the created Entity with its UUID
...
// Get EntityValuesRequest, takes the EntityUuid and returns all its values and associations with metas
...
// Get EntityValuesResponse, returns all values of an Entity with their associations with metas
...
// LinkMetaToEntityValueRequest takes a MetaUuid and an EntityValueUuid and stores a row for EntityValueMetaRel
type MetaToEntityValueRequest struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	MetaUuid        string                 `protobuf:"bytes,1,opt,name=MetaUuid,proto3" json:"MetaUuid,omitempty"`
	EntityValueUuid string                 `protobuf:"bytes,2,opt,name=EntityValueUuid,proto3" json:"EntityValueUuid,omitempty"`
	unknownFields   protoimpl.UnknownFields
...
func (x *MetaToEntityValueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetaToEntityValueRequest) GetEntityValueUuid() string {
	if x != nil {
		return x.EntityValueUuid
	}
	return ""
...
// LinkMetaToEntityValueResponse returns the success of the operation
type MetaToEntityValueResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MetaToEntityValueResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_cells_idm_proto_rawDesc = "" +
	...
	"\x03not\x18\x05 \x01(\bR\x03not\"d\n" +
	"\x1cLinkMetaToEntityValueRequest\x12\x1a\n" +
	"\bMetaUuid\x18\x01 \x01(\tR\bMetaUuid\x12(\n" +
	"\x0fEntityValueUuid\x18\x02 \x01(\tR\x0fEntityValueUuid\"N\n" +
	"\x12GetMetadataRequest\x12\x1a\n" +
	...
	"\vEntityValue\x18\x01 \x03(\v2\x10.idm.EntityValueR\vEntityValue\"`\n" +
	"\x18MetaToEntityValueRequest\x12\x1a\n" +
	"\bMetaUuid\x18\x01 \x01(\tR\bMetaUuid\x12(\n" +
	"\x0fEntityValueUuid\x18\x02 \x01(\tR\x0fEntityValueUuid\"5\n" +
	"\x19MetaToEntityValueResponse\x12\x18\n" +
...
var file_cells_idm_proto_goTypes = []any{
	...
	(*LinkMetaToEntityValueRequest)(nil),             // 50: idm.LinkMetaToEntityValueRequest
	(*GetMetadataRequest)(nil),                       // 51: idm.GetMetadataRequest
	(*CreateEntityValueRequest)(nil),                 // 52: idm.CreateEntityValueRequest
