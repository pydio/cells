...
var file_cells_idm_proto_rawDesc = []byte{
	...
	0x2f, 0x69, 0x64, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_cells_idm_proto_depIdxs = []int32{
	...
	66, // 90: idm.PolicyEngineService.StreamPolicyGroups:input_type -> idm.ListPolicyGroupsRequest
	64, // 91: idm.PolicyEngineService.DeletePolicyGroup:input_type -> idm.DeletePolicyGroupRequest
	8,  // 92: idm.RoleService.CreateRole:output_type -> idm.CreateRoleResponse
	10, // 93: idm.RoleService.DeleteRole:output_type -> idm.DeleteRoleResponse
	12, // 94: idm.RoleService.SearchRole:output_type -> idm.SearchRoleResponse
	12, // 95: idm.RoleService.StreamRole:output_type -> idm.SearchRoleResponse
	13, // 96: idm.RoleService.CountRole:output_type -> idm.CountRoleResponse
	17, // 97: idm.UserService.CreateUser:output_type -> idm.CreateUserResponse
	21, // 98: idm.UserService.DeleteUser:output_type -> idm.DeleteUserResponse
	19, // 99: idm.UserService.BindUser:output_type -> idm.BindUserResponse
	24, // 100: idm.UserService.CountUser:output_type -> idm.CountUserResponse
	23, // 101: idm.UserService.SearchUser:output_type -> idm.SearchUserResponse
	23, // 102: idm.UserService.StreamUser:output_type -> idm.SearchUserResponse
	28, // 103: idm.WorkspaceService.CreateWorkspace:output_type -> idm.CreateWorkspaceResponse
	30, // 104: idm.WorkspaceService.DeleteWorkspace:output_type -> idm.DeleteWorkspaceResponse
	32, // 105: idm.WorkspaceService.SearchWorkspace:output_type -> idm.SearchWorkspaceResponse
	32, // 106: idm.WorkspaceService.StreamWorkspace:output_type -> idm.SearchWorkspaceResponse
	36, // 107: idm.ACLService.CreateACL:output_type -> idm.CreateACLResponse
	38, // 108: idm.ACLService.ExpireACL:output_type -> idm.ExpireACLResponse
	40, // 109: idm.ACLService.DeleteACL:output_type -> idm.DeleteACLResponse
	42, // 110: idm.ACLService.SearchACL:output_type -> idm.SearchACLResponse
	42, // 111: idm.ACLService.StreamACL:output_type -> idm.SearchACLResponse
	49, // 112: idm.UserMetaService.UpdateUserMeta:output_type -> idm.UpdateUserMetaResponse
	51, // 113: idm.UserMetaService.SearchUserMeta:output_type -> idm.SearchUserMetaResponse
	53, // 114: idm.UserMetaService.UpdateUserMetaNamespace:output_type -> idm.UpdateUserMetaNamespaceResponse
	55, // 115: idm.UserMetaService.ListUserMetaNamespace:output_type -> idm.ListUserMetaNamespaceResponse
	58, // 116: idm.PolicyEngineService.IsAllowed:output_type -> idm.PolicyEngineResponse
	63, // 117: idm.PolicyEngineService.StorePolicyGroup:output_type -> idm.StorePolicyGroupResponse
	67, // 118: idm.PolicyEngineService.ListPolicyGroups:output_type -> idm.ListPolicyGroupsResponse
	61, // 119: idm.PolicyEngineService.StreamPolicyGroups:output_type -> idm.PolicyGroup
	65, // 120: idm.PolicyEngineService.DeletePolicyGroup:output_type -> idm.DeletePolicyGroupResponse
