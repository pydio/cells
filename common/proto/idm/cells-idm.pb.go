...
var file_cells_idm_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x88,
	0x02, 0x0a, 0x0b, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x1a,
	0x0a, 0x04, 0x55, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0x48,
	0x03, 0xc8, 0x01, 0x01, 0x52, 0x04, 0x55, 0x75, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x91, 0x03, 0x0a, 0x0b, 0x55, 0x73,
...
var file_cells_idm_proto_msgTypes = make([]protoimpl.MessageInfo, 69)
var file_cells_idm_proto_goTypes = []interface{}{
	...
	(*PolicyGroup)(nil),                              // 64: idm.PolicyGroup
	(*StorePolicyGroupRequest)(nil),                  // 65: idm.StorePolicyGroupRequest
	(*StorePolicyGroupResponse)(nil),                 // 66: idm.StorePolicyGroupResponse
	(*DeletePolicyGroupRequest)(nil),                 // 67: idm.DeletePolicyGroupRequest
	(*DeletePolicyGroupResponse)(nil),                // 68: idm.DeletePolicyGroupResponse
	(*ListPolicyGroupsRequest)(nil),                  // 69: idm.ListPolicyGroupsRequest
	(*ListPolicyGroupsResponse)(nil),                 // 70: idm.ListPolicyGroupsResponse
	nil,                                              // 71: idm.User.AttributesEntry
	nil,                                              // 72: idm.Workspace.RootNodesEntry
	nil,                                              // 73: idm.ChangeEvent.AttributesEntry
	nil,                                              // 74: idm.PolicyEngineRequest.ContextEntry
	nil,                                              // 75: idm.Policy.ConditionsEntry
	(*service.Query)(nil),                            // 76: service.Query
	(*service.ResourcePolicy)(nil),                   // 77: service.ResourcePolicy
	(*tree.TreeNode)(nil),                            // 78: tree.TreeNode
	(*tree.Node)(nil),                                // 79: tree.Node
	(*service.ResourcePolicyQuery)(nil),              // 80: service.ResourcePolicyQuery
}
var file_cells_idm_proto_depIdxs = []int32{
	...
	76, // 2: idm.DeleteRoleRequest.Query:type_name -> service.Query
	76, // 3: idm.SearchRoleRequest.Query:type_name -> service.Query
	14, // 4: idm.SearchRoleResponse.Role:type_name -> idm.Role
	77, // 5: idm.Role.Policies:type_name -> service.ResourcePolicy
	...
	76, // 9: idm.DeleteUserRequest.Query:type_name -> service.Query
	76, // 10: idm.SearchUserRequest.Query:type_name -> service.Query
	26, // 11: idm.SearchUserResponse.User:type_name -> idm.User
	78, // 12: idm.TreeUser.node:type_name -> tree.TreeNode
	26, // 13: idm.TreeUser.user:type_name -> idm.User
	71, // 14: idm.User.Attributes:type_name -> idm.User.AttributesEntry
	14, // 15: idm.User.Roles:type_name -> idm.Role
	77, // 16: idm.User.Policies:type_name -> service.ResourcePolicy
	...
	76, // 20: idm.DeleteWorkspaceRequest.Query:type_name -> service.Query
	76, // 21: idm.SearchWorkspaceRequest.Query:type_name -> service.Query
	34, // 22: idm.SearchWorkspaceResponse.Workspace:type_name -> idm.Workspace
	1,  // 23: idm.Workspace.Scope:type_name -> idm.WorkspaceScope
	77, // 24: idm.Workspace.Policies:type_name -> service.ResourcePolicy
	72, // 25: idm.Workspace.RootNodes:type_name -> idm.Workspace.RootNodesEntry
	...
	76, // 29: idm.ExpireACLRequest.Query:type_name -> service.Query
	76, // 30: idm.DeleteACLRequest.Query:type_name -> service.Query
	76, // 31: idm.SearchACLRequest.Query:type_name -> service.Query
	47, // 32: idm.SearchACLResponse.ACL:type_name -> idm.ACL
	76, // 33: idm.RestoreACLRequest.Query:type_name -> service.Query
	46, // 34: idm.ACL.Action:type_name -> idm.ACLAction
	46, // 35: idm.ACLSingleQuery.Actions:type_name -> idm.ACLAction
	77, // 36: idm.UserMeta.Policies:type_name -> service.ResourcePolicy
	79, // 37: idm.UserMeta.ResolvedNode:type_name -> tree.Node
	77, // 38: idm.UserMetaNamespace.Policies:type_name -> service.ResourcePolicy
	...
	80, // 42: idm.SearchUserMetaRequest.ResourceQuery:type_name -> service.ResourcePolicyQuery
	...
	73, // 54: idm.ChangeEvent.Attributes:type_name -> idm.ChangeEvent.AttributesEntry
	74, // 55: idm.PolicyEngineRequest.Context:type_name -> idm.PolicyEngineRequest.ContextEntry
	3,  // 56: idm.Policy.effect:type_name -> idm.PolicyEffect
	75, // 57: idm.Policy.conditions:type_name -> idm.Policy.ConditionsEntry
	4,  // 58: idm.PolicyGroup.ResourceGroup:type_name -> idm.PolicyResourceGroup
	63, // 59: idm.PolicyGroup.Policies:type_name -> idm.Policy
	64, // 60: idm.StorePolicyGroupRequest.PolicyGroup:type_name -> idm.PolicyGroup
	64, // 61: idm.StorePolicyGroupResponse.PolicyGroup:type_name -> idm.PolicyGroup
	64, // 62: idm.DeletePolicyGroupRequest.PolicyGroup:type_name -> idm.PolicyGroup
	64, // 63: idm.ListPolicyGroupsResponse.PolicyGroups:type_name -> idm.PolicyGroup
	79, // 64: idm.Workspace.RootNodesEntry.value:type_name -> tree.Node
	62, // 65: idm.Policy.ConditionsEntry.value:type_name -> idm.PolicyCondition
	7,  // 66: idm.RoleService.CreateRole:input_type -> idm.CreateRoleRequest
	9,  // 67: idm.RoleService.DeleteRole:input_type -> idm.DeleteRoleRequest
	11, // 68: idm.RoleService.SearchRole:input_type -> idm.SearchRoleRequest
	11, // 69: idm.RoleService.StreamRole:input_type -> idm.SearchRoleRequest
	11, // 70: idm.RoleService.CountRole:input_type -> idm.SearchRoleRequest
	16, // 71: idm.UserService.CreateUser:input_type -> idm.CreateUserRequest
	20, // 72: idm.UserService.DeleteUser:input_type -> idm.DeleteUserRequest
	18, // 73: idm.UserService.BindUser:input_type -> idm.BindUserRequest
	22, // 74: idm.UserService.CountUser:input_type -> idm.SearchUserRequest
	22, // 75: idm.UserService.SearchUser:input_type -> idm.SearchUserRequest
	22, // 76: idm.UserService.StreamUser:input_type -> idm.SearchUserRequest
	28, // 77: idm.WorkspaceService.CreateWorkspace:input_type -> idm.CreateWorkspaceRequest
	30, // 78: idm.WorkspaceService.DeleteWorkspace:input_type -> idm.DeleteWorkspaceRequest
	32, // 79: idm.WorkspaceService.SearchWorkspace:input_type -> idm.SearchWorkspaceRequest
	32, // 80: idm.WorkspaceService.StreamWorkspace:input_type -> idm.SearchWorkspaceRequest
	36, // 81: idm.ACLService.CreateACL:input_type -> idm.CreateACLRequest
	38, // 82: idm.ACLService.ExpireACL:input_type -> idm.ExpireACLRequest
	40, // 83: idm.ACLService.DeleteACL:input_type -> idm.DeleteACLRequest
	42, // 84: idm.ACLService.SearchACL:input_type -> idm.SearchACLRequest
	42, // 85: idm.ACLService.StreamACL:input_type -> idm.SearchACLRequest
	44, // 86: idm.ACLService.RestoreACL:input_type -> idm.RestoreACLRequest
	51, // 87: idm.UserMetaService.UpdateUserMeta:input_type -> idm.UpdateUserMetaRequest
	53, // 88: idm.UserMetaService.SearchUserMeta:input_type -> idm.SearchUserMetaRequest
	55, // 89: idm.UserMetaService.UpdateUserMetaNamespace:input_type -> idm.UpdateUserMetaNamespaceRequest
	57, // 90: idm.UserMetaService.ListUserMetaNamespace:input_type -> idm.ListUserMetaNamespaceRequest
	60, // 91: idm.PolicyEngineService.IsAllowed:input_type -> idm.PolicyEngineRequest
	65, // 92: idm.PolicyEngineService.StorePolicyGroup:input_type -> idm.StorePolicyGroupRequest
	69, // 93: idm.PolicyEngineService.ListPolicyGroups:input_type -> idm.ListPolicyGroupsRequest
	69, // 94: idm.PolicyEngineService.StreamPolicyGroups:input_type -> idm.ListPolicyGroupsRequest
	67, // 95: idm.PolicyEngineService.DeletePolicyGroup:input_type -> idm.DeletePolicyGroupRequest
	8,  // 96: idm.RoleService.CreateRole:output_type -> idm.CreateRoleResponse
	10, // 97: idm.RoleService.DeleteRole:output_type -> idm.DeleteRoleResponse
	12, // 98: idm.RoleService.SearchRole:output_type -> idm.SearchRoleResponse
	12, // 99: idm.RoleService.StreamRole:output_type -> idm.SearchRoleResponse
	13, // 100: idm.RoleService.CountRole:output_type -> idm.CountRoleResponse
	17, // 101: idm.UserService.CreateUser:output_type -> idm.CreateUserResponse
	21, // 102: idm.UserService.DeleteUser:output_type -> idm.DeleteUserResponse
	19, // 103: idm.UserService.BindUser:output_type -> idm.BindUserResponse
	24, // 104: idm.UserService.CountUser:output_type -> idm.CountUserResponse
	23, // 105: idm.UserService.SearchUser:output_type -> idm.SearchUserResponse
	23, // 106: idm.UserService.StreamUser:output_type -> idm.SearchUserResponse
	29, // 107: idm.WorkspaceService.CreateWorkspace:output_type -> idm.CreateWorkspaceResponse
	31, // 108: idm.WorkspaceService.DeleteWorkspace:output_type -> idm.DeleteWorkspaceResponse
	33, // 109: idm.WorkspaceService.SearchWorkspace:output_type -> idm.SearchWorkspaceResponse
	33, // 110: idm.WorkspaceService.StreamWorkspace:output_type -> idm.SearchWorkspaceResponse
	37, // 111: idm.ACLService.CreateACL:output_type -> idm.CreateACLResponse
	39, // 112: idm.ACLService.ExpireACL:output_type -> idm.ExpireACLResponse
	41, // 113: idm.ACLService.DeleteACL:output_type -> idm.DeleteACLResponse
	43, // 114: idm.ACLService.SearchACL:output_type -> idm.SearchACLResponse
	43, // 115: idm.ACLService.StreamACL:output_type -> idm.SearchACLResponse
	45, // 116: idm.ACLService.RestoreACL:output_type -> idm.RestoreACLResponse
	52, // 117: idm.UserMetaService.UpdateUserMeta:output_type -> idm.UpdateUserMetaResponse
	54, // 118: idm.UserMetaService.SearchUserMeta:output_type -> idm.SearchUserMetaResponse
	56, // 119: idm.UserMetaService.UpdateUserMetaNamespace:output_type -> idm.UpdateUserMetaNamespaceResponse
	58, // 120: idm.UserMetaService.ListUserMetaNamespace:output_type -> idm.ListUserMetaNamespaceResponse
	61, // 121: idm.PolicyEngineService.IsAllowed:output_type -> idm.PolicyEngineResponse
	66, // 122: idm.PolicyEngineService.StorePolicyGroup:output_type -> idm.StorePolicyGroupResponse
	70, // 123: idm.PolicyEngineService.ListPolicyGroups:output_type -> idm.ListPolicyGroupsResponse
	64, // 124: idm.PolicyEngineService.StreamPolicyGroups:output_type -> idm.PolicyGroup
	68, // 125: idm.PolicyEngineService.DeletePolicyGroup:output_type -> idm.DeletePolicyGroupResponse
