...
type NodeKey struct {
	...
	NodeId  string `protobuf:"bytes,1,opt,name=NodeId,proto3" json:"NodeId,omitempty" gorm:"column:node_id;"`
	UserId  string `protobuf:"bytes,2,opt,name=UserId,proto3" json:"UserId,omitempty" gorm:"column:user_id;"`
	OwnerId string `protobuf:"bytes,3,opt,name=OwnerId,proto3" json:"OwnerId,omitempty" gorm:"column:owner_id;"`
...
type RangedBlock struct {
	...
	OwnerId    string `protobuf:"bytes,1,opt,name=OwnerId,proto3" json:"OwnerId,omitempty" gorm:"column:owner;"`
	...
	NodeId     string `protobuf:"bytes,7,opt,name=NodeId,proto3" json:"NodeId,omitempty" gorm:"column:node_id;"`
	Nonce      []byte `protobuf:"bytes,8,opt,name=Nonce,proto3" json:"Nonce,omitempty" gorm:"column:nonce;"`
}
