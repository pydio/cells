...
var file_cells_update_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x75, 0x70, 0x64, 0x61,
...
func file_cells_update_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cells_update_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_cells_update_proto_msgTypes[10].Exporter = func(v any, i int) any {
