...
// defaultsRegistry is a slice of jobs that can be reset on demand
var defaultsRegistry []*DefaultJob

// RegisterDefault appends a job to the internal registry
func RegisterDefault(j *Job, service string) {
	defaultsRegistry = append(defaultsRegistry, &DefaultJob{Job: j, ServiceName: service})
}
