...
type URLOpener interface {
	OpenURL(ctx context.Context, u *url.URL) (certmagic.Storage, error)
}
...
func (mux *URLMux) OpenStore(ctx context.Context, urlstr string) (certmagic.Storage, error) {
...
func OpenStore(ctx context.Context, urlstr string) (certmagic.Storage, error) {
