...
func TestGenerateProtoToForm(t *testing.T) {
	Convey("Test role", t, func() {
		...
		So(string(b), ShouldEqual, `<form><param name="fieldname" type="group_switch:fieldname" label="Field Name" group=""></param><param group_switch_name="fieldname" group_switch_value="RoleIDs" group_switch_label="RoleIDs" name="@value" type="hidden" group="" default="RoleIDs"></param><param group_switch_name="fieldname" group_switch_value="RoleIDs" group_switch_label="RoleIDs" name="RoleIDs" type="string" label="RoleIDs" group="" replicationGroup="RoleIDs" replicationTitle="RoleIDs[]" replicationMandatory="false"></param><param group_switch_name="fieldname" group_switch_value="WorkspaceIDs" group_switch_label="WorkspaceIDs" name="@value" type="hidden" group="" default="WorkspaceIDs"></param><param group_switch_name="fieldname" group_switch_value="WorkspaceIDs" group_switch_label="WorkspaceIDs" name="WorkspaceIDs" type="string" label="WorkspaceIDs" group="" replicationGroup="WorkspaceIDs" replicationTitle="WorkspaceIDs[]" replicationMandatory="false"></param><param group_switch_name="fieldname" group_switch_value="NodeIDs" group_switch_label="NodeIDs" name="@value" type="hidden" group="" default="NodeIDs"></param><param group_switch_name="fieldname" group_switch_value="NodeIDs" group_switch_label="NodeIDs" name="NodeIDs" type="string" label="NodeIDs" group="" replicationGroup="NodeIDs" replicationTitle="NodeIDs[]" replicationMandatory="false"></param><param group_switch_name="fieldname" group_switch_value="not" group_switch_label="Not" name="@value" type="hidden" group="" default="not"></param><param group_switch_name="fieldname" group_switch_value="not" group_switch_label="Not" name="not" type="boolean" label="not" group=""></param><param group_switch_name="fieldname" group_switch_value="Actions" group_switch_label="Actions" name="@value" type="hidden" group="" default="Actions"></param><param group_switch_name="fieldname" group_switch_value="Actions" group_switch_label="Actions" name="Name" type="string" label="Name" group="" replicationGroup="Actions" replicationTitle="Actions" replicationDescription="Acl Actions" replicationMandatory="false"></param><param group_switch_name="fieldname" group_switch_value="Actions" group_switch_label="Actions" name="Value" type="string" label="Value" group="" replicationGroup="Actions" replicationTitle="Actions" replicationDescription="Acl Actions" replicationMandatory="false"></param></form>`)
