...
func TestWithinPeriodCondition(t *testing.T) {
	...
	Convey("Canonical within period tests", t, func() {
		...
		for _, c := range []struct {
			...
			{matches: "2006-01-02T15:04-0700/2006-02-02T15:04-0700", value: "2006-02-01T15:04-0700", pass: true},
			{matches: "2006-01-02T15:04-0700/2006-02-02T15:04-0700", value: "2006-02-01T17:04-0100", pass: true},
			{matches: "2006-01-02T15:04-0700/2006-02-02T15:04-0700", value: "2006-02-03T15:04-0700", pass: false},
		} {
			condition := &WithinPeriodCondition{
				Matches: c.matches,
			}
...
func TestWithinPeriodPolicies(t *testing.T) {
	...
	Convey("Test DateWithinPeriodPolicy", t, func() {
		...
		ladonPolicy := &ladon.DefaultPolicy{
			...
			Conditions: ladon.Conditions{
				errors.ClientTime: &WithinPeriodCondition{
