...
// NewAdminLoadShareListParams creates a new AdminLoadShareListParams object
// with the default values initialized.
func NewAdminLoadShareListParams() *AdminLoadShareListParams {
	var ()
	return &AdminLoadShareListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminLoadShareListParamsWithTimeout creates a new AdminLoadShareListParams object
...
// NewAdminLoadShareListParamsWithContext creates a new AdminLoadShareListParams object
...
// NewAdminLoadShareListParamsWithHTTPClient creates a new AdminLoadShareListParams object
...
/*AdminLoadShareListParams contains all the parameters to send to the API endpoint
for the admin load share list operation typically these are written to a http.Request
*/
...
func (o *AdminLoadShareListParams) WithTimeout(timeout time.Duration) *AdminLoadShareListParams {
...
func (o *AdminLoadShareListParams) WithContext(ctx context.Context) *AdminLoadShareListParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminLoadShareListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
