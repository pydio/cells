...
lint:
	@echo "Running $@"
	@${GOPATH}/bin/golint -set_exit_status github.com/pydio/minio-srv/cmd...
	@${GOPATH}/bin/golint -set_exit_status github.com/pydio/minio-srv/pkg...
...
test: verifiers build
	...
	@go test $(GOFLAGS) .
	@go test $(GOFLAGS) github.com/pydio/minio-srv/cmd...
	@go test $(GOFLAGS) github.com/pydio/minio-srv/pkg...
